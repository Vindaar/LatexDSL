type
  LatexCommands* = enum
    ...
    intextsep, invisiblesection, iota, it, item, itemindent, itemize, itemsep, 
    j, jmath, kappa, ker, kill, l, label, labelsep, labeltext, labelwidth, 
    lambda, land, langle, large, lbrace, lbrack, lceil, ldots, le, leadsto, 
    left, leftarrow, lefteqnformula, leftharpoondown, leftharpoonup, 
    leftmargin, leftmargini, leftmarginvi, leftrightarrow, leq, lfloor, lg, 
    lhd, lim, liminf, limsup, line, linebreak, linethicknessdimen, linewidth, 
    list, listoffigures, listoftables, listparindent, ll, ln, lnot, log, 
    longleftarrow, longleftrightarrow, longmapsto, longrightarrow, lor, lq, 
    makebox, makeglossary, makeindex, maketitle, mapsto, marginparpush, 
    marginparsep, marginpartext, marginparwidth, markbothlhd, markrightrhd, 
    math, max, mbox, mboxtext, medskip, medskipamount, mho, mid, midrule, min, 
    minipage, mit, models, month, mp, mu, multicolumnnoc, multiput, nabla, 
    natural, ne, nearrow, neg, neq, newcolumntype, newcommand, 
    newcountercounter, newenvironment, newenvironmentenvname, newfontcs, 
    newlength, newline, newpage, newtheorem, newtheoremenv, ni, nl, nofiles, 
    noindent, nolinebreak, nonumber, nopagebreak, normalmarginpar, normalsize, 
    `not`, `notin`, nu, num, nwarrow, o, obeycr, oddsidemargin, odot, oe, 
    oint, omega, ominus, onecolumn, openingtext, oplus, oslash, otimes, oval, 
    ...
    propto, protect, ps, psi, pushtabs, put, quotation, quote, raggedbottom, 
    raggedleft, raggedright, raiseboxdim, rangle, rbrace, rbrack, rceil, 
    refstepcounter, reftext, renewenvironmentenvname, restorecr, 
    reversemarginpar, rfloor, rhd, rho, right, rightarrow, rightharpoondown, 
    rightharpoonup, rightleftharpoons, rightmargin, rm, romancounter, rq, 
    rule, savebox, sc, scriptscriptstyle, scriptsize, scriptstyle, searrow, 
    sec, section, sectionmark, setcountercounter, setlength, setminus, 
    settowidth, sf, sharp, shortstack, si, sigma, signaturetext, sim, simeq, 
    sin, sinh, sl, sloppy, small, smallint, smallskip, smallskipamount, smile, 
    spadesuit, sqcap, sqcup, sqrt, sqsubset, sqsubseteq, sqsupset, sqsupseteq, 
    ss, stackrelf, stackrelstuff, star, stop, subparagraph, subsection, 
    subsectionmark, subset, subseteq, subsubsection, succ, succeq, sum, sup, 
    supset, supseteq, surd, swarrow, symbolcc, t, tabbing, tabbingsep, 
    tabcolsep, table, tableofcontents, tabular, tan, tanh, tau, textfloatsep, 
    textfraction, textheight, textstyle, textwidth, thanksfootnote, theorem, 
    theta, thicklines, thinlines, thinspace, thispagestylesty, tilde, tildea, 
    times, tiny, title, titlepage, titletext, to, today, too, top, 
    topfraction, topmargin, toprule, topsep, topskip, triangle, triangleleft, 
    triangleright, tt, twocolumn, typein, typeouttext, u, unboldmath, 
    underbracetext, underlinetext, unitlength, unlhd, unrhd, uo, uparrow, 
    updownarrow, uplus, upsilon, usecountercounter, usepackage, v, 
